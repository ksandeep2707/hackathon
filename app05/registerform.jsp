...
<div class="login-form">    
    <form action="#" method="post" id="myform" >
        ...
        <div class="form-group">
            <input type="text" class="form-control form" placeholder="Username" required="required" name="name">
        </div>
        <div class="form-group">
            <input type="password" class="form-control form" placeholder="Password" required="required" name="pass">
        </div> 
        <input type="submit" class="btn btn-primary btn-block btn-lg form" value="Register">
                           ...
                           $.ajax({
                               ...
                               success: function(data,textStatus,jqXHR){
                                 ...
                                 $(".loader").hide();
                                   ...
                                   else if(data.trim()==="register")
                                   {
                                     $("#msg").html("Name already exist!!!");
